...
public class ConsultaSocio_Sesion2 extends JFrame implements ActionListener {
	...
	public ConsultaSocio_Sesion2() {
		...
		anterior.setBounds(21, 271, 89, 23);
		panel.add(anterior);
		anterior.addActionListener(this);
		anterior.setEnabled(false);

		siguiente = new JButton("Siguente");
		siguiente.setBounds(140, 271, 89, 23);
		panel.add(siguiente);
		...
		anyos.setFont(new Font("Tahoma", Font.PLAIN, 12));
		anyos.setBounds(130, 151, 31, 20);
		panel.add(anyos);
		...
		btnNuevo.setBounds(311, 145, 89, 23);
		getContentPane().add(btnNuevo);
		
		JButton btnBorrar = new JButton("Borrar");
		btnBorrar.setBounds(311, 220, 89, 23);
