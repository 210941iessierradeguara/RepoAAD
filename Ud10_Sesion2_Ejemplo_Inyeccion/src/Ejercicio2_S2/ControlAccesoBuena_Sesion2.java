...
public class ControlAccesoBuena_Sesion2 extends JFrame implements ActionListener {
	...
	public ControlAccesoBuena_Sesion2() {
		...
		contrasenya.setFont(new Font("Tahoma", Font.PLAIN, 14));
		contrasenya.setBounds(21, 87, 80, 33);
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			Respuesta.setText(abd.compruebaContrasenya(usuarioText.getText(), passwordText.getText()));
		} catch (SQLException e1) {
			System.out.println("Usuario o contrase�as incorrectos");
		};
		
		try {
			if (abd.reg.getNString(3).equals(abd.compruebaContrasenya(usuarioText.getText(), passwordText.getText()))) {
